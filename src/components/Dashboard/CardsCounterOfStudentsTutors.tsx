...
type Props = {
  ...
  numberOfStudentsWhoNotHaveTutor?: string | number,
}

const CardsCounterOfStudentsTutors = ({
  numberOfStudents = '',
  numberOfTutors = '',
  numberOfStudentsWhoNotHaveTutor = ''
}: Props) => {
  return (
      ...
      <div className="card border-right">
        <div className="card-body">
          <div className="d-flex d-lg-flex d-md-block align-items-center">
            <div>
              <div className="d-inline-flex align-items-center">
                <h2 className="text-dark mb-1 font-weight-medium">{numberOfStudentsWhoNotHaveTutor}</h2>
              </div>
              <h6 className="text-muted font-weight-normal mb-0 w-100 text-truncate">Students <br /> Not have tutor</h6>
            </div>
          </div>
        </div>
      </div>
