      ...
      <div className="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav className="sidebar-nav">
          <ul id="sidebarnav">
            ...
            <li className="sidebar-item"> <a className="sidebar-link has-arrow" href="#!" aria-expanded="false"><i data-feather="file-text" className="feather-icon" /><span className="hide-menu">Forms </span></a>
            ...
            <li className="sidebar-item"> <a className="sidebar-link has-arrow" href="#!" aria-expanded="false"><i data-feather="grid" className="feather-icon" /><span className="hide-menu">Tables </span></a>
              <ul aria-expanded="false" className="collapse  first-level base-level-line">
            ...
            <li className="sidebar-item"> <a className="sidebar-link has-arrow" href="#!" aria-expanded="false"><i data-feather="bar-chart" className="feather-icon" /><span className="hide-menu">Charts </span></a>
              <ul aria-expanded="false" className="collapse  first-level base-level-line">
            ...
            <li className="sidebar-item"> <a className="sidebar-link has-arrow" href="#!" aria-expanded="false"><i data-feather="box" className="feather-icon" /><span className="hide-menu">UI Elements </span></a>
              <ul aria-expanded="false" className="collapse  first-level base-level-line">
            ...
            <li className="sidebar-item"> <a className="sidebar-link has-arrow" href="#!" aria-expanded="false"><i data-feather="feather" className="feather-icon" /><span className="hide-menu">Icons
            </span></a>
              <ul aria-expanded="false" className="collapse first-level base-level-line">
            ...
            <li className="sidebar-item"> <a className="sidebar-link has-arrow" href="#!" aria-expanded="false"><i data-feather="crosshair" className="feather-icon" /><span className="hide-menu">Multi
            level
              dd</span></a>
              <ul aria-expanded="false" className="collapse first-level base-level-line">
                <li className="sidebar-item"><a href="#!" className="sidebar-link"><span className="hide-menu"> item 1.1</span></a>
                </li>
                <li className="sidebar-item"><a href="#!" className="sidebar-link"><span className="hide-menu"> item 1.2</span></a>
                </li>
                <li className="sidebar-item"> <a className="has-arrow sidebar-link" href="#!" aria-expanded="false"><span className="hide-menu">Menu 1.3</span></a>
                  <ul aria-expanded="false" className="collapse second-level base-level-line">
                    <li className="sidebar-item"><a href="#!" className="sidebar-link"><span className="hide-menu"> item
                      1.3.1</span></a></li>
                    <li className="sidebar-item"><a href="#!" className="sidebar-link"><span className="hide-menu"> item
                      1.3.2</span></a></li>
                    <li className="sidebar-item"><a href="#!" className="sidebar-link"><span className="hide-menu"> item
